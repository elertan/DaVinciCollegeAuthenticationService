...
namespace DaVinciCollegeAuthenticationService.Data.Migrations
{
    ...
    [Migration("20161128083520_addedextrarowsApplicationUser")]
    partial class addedextrarowsApplicationUser
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("DaVinciCollegeAuthenticationService.Models.Application", b =>
                {
                    ...
                    b.Property<bool>("ExtendExpiryOnRequest");

                    b.Property<string>("LoginCallbackUrl");
            ...
            modelBuilder.Entity("DaVinciCollegeAuthenticationService.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DaVinciCollegeAuthenticationService.Models.ApplicationUser")
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
